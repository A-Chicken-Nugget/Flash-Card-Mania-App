...
public class LibraryListingOnly {
    private View panel;
    private Library library;

    public LibraryListingOnly(Context context, LinearLayout layout, Library library) {
        panel = LayoutInflater.from(context).inflate(R.layout.library_listing_only, layout, false);
    ...
    public View getInnerPanel() {
        return panel.findViewById(R.id.libraryListingOnly_bodyConstraint);
    }
